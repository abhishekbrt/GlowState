...
abstract class $PhotoRecordCopyWith<$Res> {
  factory $PhotoRecordCopyWith(
          PhotoRecord value, $Res Function(PhotoRecord) then) =
...
abstract class _$$PhotoRecordImplCopyWith<$Res>
  ...
  factory _$$PhotoRecordImplCopyWith(
          _$PhotoRecordImpl value, $Res Function(_$PhotoRecordImpl) then) =
...
class __$$PhotoRecordImplCopyWithImpl<$Res>
  ...
  __$$PhotoRecordImplCopyWithImpl(
      _$PhotoRecordImpl _value, $Res Function(_$PhotoRecordImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PhotoRecordImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$PhotoRecordImpl extends _PhotoRecord {
  ...
  int get hashCode => Object.hash(runtimeType, id, filePath, capturedAt,
      checkInType, isPrivate, thumbnailPath, cycleDay, notes);
  ...
  Map<String, dynamic> toJson() {
    return _$$PhotoRecordImplToJson(
      this,
    );
  }
}
...
abstract class _PhotoRecord extends PhotoRecord {
  const factory _PhotoRecord(
      ...
      final String? thumbnailPath,
      final int? cycleDay,
      final String? notes}) = _$PhotoRecordImpl;
